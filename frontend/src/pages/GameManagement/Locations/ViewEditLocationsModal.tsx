...
import NameInput from './LocationParts/NameInput';
import LocationTypeDropdown from './LocationParts/LocationTypeDropdown';
import LocationModifierDropdown from './LocationParts/LocationModifierDropdown';
import AppearanceInput from './LocationParts/AppearanceInput';
import NatureSection from './LocationParts/NatureSection';
import SocietySection from './LocationParts/SocietySection';
import ParentSection from './LocationParts/ParentSection';
import ChildrenSection from './LocationParts/ChildrenSection';
import LocationAnomalyInput from './LocationParts/LocationAnomalyInput';
import SummaryInput from './LocationParts/SummaryInput';
import PositionOnParent from './LocationParts/PositionOnParent';
               ...
               <div style={{
                  ...
                  <div style={{
                     ...
                     <ParentSection currentNameInput={locationParentName}
                        setCurrentNameInput={setLocationParentName}
                        currentTypeInput={locationParentType}
                        setCurrentTypeInput={setLocationParentType}
                     ...
                     />
                     {locationParentName && <PositionOnParent 
                     ...
                     />}
                     <ChildrenSection 
                        currentInput={locationChildren}
                        setCurrentInput={setLocationChildren}
